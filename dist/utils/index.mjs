...
export { applyIsOptionalDecorator, applyValidateIfDefinedDecorator, inheritPropertyInitializers, inheritTransformationMetadata, inheritValidationMetadata, isClassTransformerAvailable, isClassValidatorAvailable, logger };
